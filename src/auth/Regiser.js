...
import { validEmail, validName, validPassword, validUserName } from "./Regex";
...
function Register() {
    ...
    return (
        <>
            <div className="container cntr rounded-4 shadow bg-dark p-5  mb-5 mt-5">
                <div className="row ">
                    <div className="col-lg-7">
                        <h1 className="text-light" ><b>Sign up </b></h1>
                        <form className=" mt-5" onSubmit={(e) => submitData(e)} >
                            ...
                            <div className="form-check mb-4 mt-4">
                                ...
                                <label className="form-check-label text-light" htmlFor="checkTerminas">
                                    I agree all statements in <a className="card-link text-light" href="#"> Terms of service </a>
                                </label>
                    ...
                    <div className="col-lg-5">
                        <div className="text-center p-5">
                            <img className="mb-0 rounded-4" src={require("./minion2.jpg")} width="100%" alt="" />
                        </div>
                        <div className="text-center">
                            <Link className="card-link text-light " to="/"> <b> I am already member </b> </Link>
                        </div>
